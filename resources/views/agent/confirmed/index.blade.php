    ...
    <script>
        ...
        $(document).ready(function () {
                    ...
                    drawCallback: function (settings) {
                        ...
                        $(".btn_check_uncheck").click(function () {
                            ...
                            if (status == 'PENDING') {
                                ...
                                $.ajax({
                                    method: "get",
                                    url: "/agent/confirmed/update/" + id + "/INTRANSIT"
                                });
                            } else {
                                /* update the button class*/
                                ...
                                $.ajax({
                                    method: "get",
                                    url: "/agent/confirmed/update/" + id + "/PENDING/"
                                });
                            }
            ...
            $("#btn_check_all").click(function () {
                ...
                $.ajax({
                    method: "get",
                    url: "/agent/confirmed/dr/check_all/" + dr
                }).done(function (msg) {
                    updateItemTable(dr);
                });
            });
            ...
            $("#btn_uncheck_all").click(function () {
                ...
                $.ajax({
                    method: "get",
                    url: "/agent/confirmed/dr/uncheck_all/" + dr
                }).done(function (msg) {
                    updateItemTable(dr);
                });
            });
            ...
            $("#btn_confirm_final").click(function () {
                ...
                if ($("#hdn_is_confirm_all").val() != '1') {
                    ...
                    $.ajax({
                        method: "get",
                        url: "/agent/confirmed/confirm/" + dr + "/" + $("#confirm_date").val()
                    }).done(function (msg) {
                        updateItemTable(dr);
                    });
                }
                // update all
                    ...
                    $.ajax({
                        method: "get",
                        url: "/agent/confirmed/confirm_all/" + dr + "/" + $("#confirm_date").val()
                    }).done(function (msg) {
                        // hide the class
